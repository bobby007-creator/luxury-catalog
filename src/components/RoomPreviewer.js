            ...
            {showTextures && (
              <div className={styles.texturePanel} style={{ display: 'flex', gap: '10px', padding: '10px', background: '#333', overflowX: 'auto' }}>
                ...
                <label style={{ 
                  ...
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginBottom: '2px' }}><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"></path><circle cx="12" cy="13" r="4"></circle></svg>
                  <input 
                    type="file" 
                    accept="image/*" 
                    capture="environment"
                  ...
                  >
                    ...
                    {texture && (
                      <div style={{
                        ...
                        backgroundSize: texture.startsWith('blob:') ? 'cover' : '150px',
                        backgroundPosition: 'center',
                        backgroundRepeat: texture.startsWith('blob:') ? 'no-repeat' : 'repeat',
